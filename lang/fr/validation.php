...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'Le champ :attribute donné a été exposé dans une fuite de données. Merci d\'en choisir un autre.',
    ],
    ...
    */
    ...
    'custom' => [
        'due_date' => [
            'required_if' => 'La date d\'échéance est obligatoire pour une tâche de priorité haute.',
        ],
    ],

    /*
    |--------------------------------------------------------------------------
    | Noms d'attributs traduits
    |--------------------------------------------------------------------------
    |
    | Utilisés à la place du nom brut du champ (ex. "slug") dans les messages
    | ci-dessus (ex. "Le champ identifiant est obligatoire." plutôt que
    | "Le champ slug est obligatoire."). Complète (sans les remplacer) les
    | attributs définis directement dans certains Form Requests via attributes().
    |
    */
